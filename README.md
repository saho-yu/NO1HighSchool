...
### [2018 MyFirstSecurity Summer Camp 資安夏令營(申請書)]
...
>* lab1:SQli攻擊實測
>* lab2:Blind SQli攻擊實測
>* lab3:Command injection攻擊實測
>* lab4:File inclusion vuln.攻擊實測
>* lab5:File upload vuln.攻擊實測
>* lab6:web Shell

### 3.16 Python程式與求解編碼題目(MyFirstPython)
### 3.20 Python程式與求解編碼題目(MyFirstPython)
...
### 4.3(星期二)系統安全與滲透測試(MyFirstSystemSecurity)
...
### 4.13(星期五) 系統安全與滲透測試(MyFirstSystemSecurity)
...
### 5.4 MyFirstModernCrypto
### 5.8 MyFirstModernCrypto
...
### 5.11 MyFirstReversing
### 5.15(星期二)	第二次段考
### 5.18 MyFirstReversing
### 5.22 MyFirstPwn
### 5.25 MyFirstPwn
### 5.29
### 6月	高三畢業 六月後禮拜二不用上課
